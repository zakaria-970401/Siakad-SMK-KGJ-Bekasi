            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden text-center">
                        <a href="/profileadmin"><img class="img-avatar" src="{{ asset('fotoadmin/'.Auth::user()->foto)}}" style = "height: 95px; width: 130px; border-radius:50%; margin-right:15px;" alt="">
                            </a>
                            <ul class="list-inline mt-5">
                                <li class="list-inline-item">
                                    <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" >{{ Auth::user()->nama }}
                                   </li>
                            <br>
                                <li class="list-inline-item">
                                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            <li>
                                <a href="/admin/index"><i class="fa fa-terminal"></i><span class="sidebar-mini-hide">DASHBOARD ADMIN</span></a>
                            </li>
							<li class="nav-main-heading"><span class="sidebar-mini-hidden">MENU UTAMA</span></li>
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-graduation-cap"></i><span class="sidebar-mini-hide">SISWA</span></a>
                                <ul>
                                    <li>
                                        <a href="/insertsiswa">Input Data Siswa</a>
                                    </li>
                                    <li>
                                        <a href="/masterdatasiswa">Lihat Data Siswa</a>
                                    </li>
                                    <li>
                                        <a href="/masterabsensiswa">Lihat Absensi Siswa</a>
                                    </li>
                            ...
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-users"></i><span class="sidebar-mini-hide">GURU</span></a>
                                <ul>
                                    <li>
                                        <a href="/masterdataguru">Input Data Guru</a>
                                    </li>
                                    <li>
                                        <a href="/masterdataguru">Lihat Data Guru</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="fa fa-database"></i><span class="sidebar-mini-hide">MASTER DATA</span></a>
                                <ul>
                                    <li>
                                        <a href="/masterabsensiswa">Data Absensi</a>
                                    </li>
                                    <li>
                                        <a href="/masterdatasiswa">Data Siswa</a>
                                    </li>
                                    <li>
                                        <a href="/masterdatakelas">Data Kelas</a>
                                    </li>
                                    <li>
                                        <a href="/masterdataguru">Data Guru</a>
                                    </li>
                                    <li>
                                        <a href="/masterdatawalas">Data WaliKelas</a>
                                    </li>
                                    <li>
                                        <a href="/masterdatapengumuman">Data Pengumuman</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-settings"></i><span class="sidebar-mini-hide">MANAJEMEN USER</span></a>
                                <ul>
                                    <li>
                                        <a href="/gettambahakunsiswa">Akun Siswa</a>
                                    </li>
                                    <li>
                                        <a href="/masterdataguru">Akun Guru</a>
                                    </li>
                                    <li>
                                        <a href="/gettambahakunadmin">Akun Admin</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-key"></i><span class="sidebar-mini-hide">SETTING AKADEMIK</span></a>
                                <ul>
                            <li>
                                <a href="/tahunajaran">SETTING TAHUN AJARAN</a>
                            </li>
                            <li>
                                <a href="/naikkelas">SETTING NAIK KELAS</a>
                            </li>
                        </ul>
                    </li>
							<li>
							<a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-user"></i><span class="sidebar-mini-hide">Profile</span></a>
                                <ul>
                                    <li>
                                        <a href="/profileadmin">Lihat Profile</a>
                                    </li>
            ...
            <header id="page-header">
                ...
                <div class="content-header bg-image" style="background-image: url('/assets/media/photos/photo27@2x.jpg');">
                    ...
                    <div class="content-header-section">
                            ...
                            <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-djkkklao">
