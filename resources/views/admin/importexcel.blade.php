    ...
    <!-- Page Content -->
    <!-- Bootstrap Design -->
    <h2 class="content-heading">Import Data Siswa Excel</h2>
    <div class="row">
    <div class="col-md-6">
            <a href="/masterdatasiswa" class="btn btn-lg btn-primary mr-5 mb-15">
    ...
    <div class="block-content block-content-full">
     ...
     <a href="{{ url('/template_excel/TEMPLATE_DATA_SISWA.xlsx') }}" class="btn btn-lg btn-outline-success mr-5 mb-15">
    ...
    <div class="col-xl-6">
            <div class="form-group row">
                ...
                <form method="post" action="/insertsiswa/importexcel" enctype="multipart/form-data">
    {{ csrf_field() }}
                <div class="col-12">
