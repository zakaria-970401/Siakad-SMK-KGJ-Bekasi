            ...
            <div class="content">
              <div class="row gutters-tiny invisible" data-toggle="appear">
                ...
                <div class="col-6 col-xl-3">
                    <a class="block block-link-pop text-right bg-primary" href="/masterdatasiswa">
                ...
                <div class="col-6 col-xl-3">
                    <a class="block block-link-pop text-right bg-corporate" href="/gettambahakunsiswa">
                        <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                            <div class="float-left mt-10 d-none d-sm-block">
                ...
                <div class="col-6 col-xl-3">
                    <a class="block block-link-pop text-right bg-earth" href="/masterdataguru">
                        <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                            <div class="float-left mt-10 d-none d-sm-block">
                ...
                <div class="col-6 col-xl-3">
                    <a class="block block-link-pop text-right bg-elegance" href="/gettambahakunadmin">
                        <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                            <div class="float-left mt-10 d-none d-sm-block">
                                <i class="fa fa-slack fa-5x text-body-bg-dark"></i>
                            </div>
                            <div class="font-size-h3 font-w600" data-toggle="countTo" data-speed="1000" data-to="{{$dataakunadmin}}">0</div>
                            <div class="font-size-sm font-w600 text-uppercase text-muted"> AKUN ADMIN</div>
                        </div>
                    </a>
                <!-- END Row #1 -->
                </div>
                        ...
                        <div class="block-content">
                            ...
                            {{ csrf_field() }}
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="untuk" name="untuk" value="Guru" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
