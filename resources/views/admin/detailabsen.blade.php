    ...
    <div class="content">
        <div class="block">
            <div class="block-header bg-info">
                <h3 class="block-title">Surat Keterangan Absensi {{$absen->namasiswa}}</h3>
            </div>
                    <div class="content">
                     ...
                     <div class="col-lg-10 ml-auto">
                        <a href ="/masterabsensiswa" class="btn btn-primary mb-25"><i class="si si-action-undo mr-5"></i>Kembali</a>
                    </div> 
                    <br>
                    <br>
                 </div> 
