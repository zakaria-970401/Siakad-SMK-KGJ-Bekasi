        ...
        @section('judul', 'Master Data Siswa')
...
<div class="mb-10">
        ...
        <div class="block-header block-header-default">
            ...
            <a href="/pdfdatasiswa" class="btn btn-outline-danger mr-5 mb-15">
                            <i class="fa fa-file-pdf-o mr-5"></i>Export To PDF
                        </a>
                        <a href="/eksportdatasiswa" class="btn btn-outline-success mr-5 mb-15">
    ...
    <div class="col-xl-6">
        <form action="/masterdatasiswa" method="post"  enctype="multipart/form-data">
                    {{ csrf_field() }}
         <div class="form-group row">
                <label class="col-2 mt-5" for="val-select2">Cari Siswa</span></label>
                <div class="col-6">
                    ...
                    <thead>
                        ...
                        @foreach($siswa as $si)
                            <tr>
                                ...
                                <td class="text-center"><a href="/masterdetailsiswa/{{$si->id}}">{{$si->namasiswa}}</a></td>
                                ...
                                <a href="/masterdetailsiswa/{{ $si -> id}}" class="btn btn-sm btn-primary mb-5"><i class="si si-eye mr-5"></i>Detail</a>
                                <form action="/hapussiswa/{{$si->id}}" method="post" class="d-inline">
                            @method('delete')
                            @csrf
                            <button type="submit" class="btn btn-sm btn-danger mb-5"><i class="fa fa-times mr-5"></i>Hapus</a></button>
                    </form>
                            </tr>
                            @endforeach
                ...
                <br>
                        <div class="col-xl-10">
                            <form class="js-validation-bootstrap" action="/insertsiswa" method="post">
                            {{ csrf_field() }}
                                <div class="form-group row">
                    ...
                    @enderror
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="nisn">s</label>
                                    <div class="col-lg-8">
                    ...
                    @enderror
                        ...
                        <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-select2">Kelas</label>
                                    <div class="col-lg-8">
