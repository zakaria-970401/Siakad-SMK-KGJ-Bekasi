...
@section('judul', 'Update Akun Guru')


@section('konten')
<!-- Main Container -->
<div class="content">
    <a href="/guru/profileguru" class="btn btn-rounded btn-hero btn-sm btn-info mb-5">
            ...
            <div class="col-md-6">
                <div class="block">
                    ...
                    <div class="col justify-content-center py-20">
                        <div class="col-xl-8">
                            <form action="/guru/updateakunguru/{{$guru->id}}" method="post">
                            @method('patch')
                        {{ csrf_field() }}
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <span class="text-danger">*Hubungi Admin Jika Salah Input.</span>
                            </div>
                        </div>
    ...
    <div class="col-md-6">
        ...
        <br>
				...
				<i class="fa fa-pencil mr-5" ></i> Ganti Password Dan Foto
			</button>
                </div>
          </div>
          <div class="modal fade" id="modal-fromleft" tabindex="-1" role="dialog" aria-labelledby="modal-fromleft" aria-hidden="true">
            ...
            <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <br>
                                <div class="col-xl-10">
                                    <form action="/guru/updatepasswordguru/{{$guru->id}}" method="post" enctype="multipart/form-data">
                                    @method('patch')
                                    {{ csrf_field() }}
                                        <div class="form-group row">
