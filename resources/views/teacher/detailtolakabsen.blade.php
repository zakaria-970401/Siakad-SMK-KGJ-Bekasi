        ...
        <div class="block">
            <div class="block-header bg-info">
                <h3 class="block-title">Form Tolak Absensi Siswa </h3>
                    ...
                    <div class="content">
                      <form action="/guru/tolakabsen/{{$absen->id}}" method="post" enctype="multipart/form-data">
                      @method('patch')
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                                <div class="col-lg-10 ml-auto">
                                    <a href ="/guru/verifikasiabsen" class="btn btn-primary mb-25"><i class="si si-action-undo mr-5"></i>Kembali</a>
